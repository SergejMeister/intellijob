 ...
 */
public class JobLinkControllerTest extends BaseTester {
    ...
    public void findInMailsAndSaveLive() {
        ...
        List<JobLink> result = jobLinkController.findInMailsAndSave();
        Assert.assertTrue("Should be not null or empty", result.size() > 0);
    }
}
